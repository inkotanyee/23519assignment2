...
function changeOption() {
  ...
  if (l1.value === "1") {
    l2.innerHTML = 
  "<option>Software</option><option>Info</option><option>Networks</option>";
  } else if (l1.value === "2") {
    l2.innerHTML =
  "<option>Business administration</option><option>Marketing</option><option>Human Resource</option>";
  } else if (l1.value === "3") {
    l2.innerHTML =
  "<option>Accounting</option><option>Finance</option><option>Economy</option>";
  }
else{
